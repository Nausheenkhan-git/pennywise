...
export default function Sidebar({ achievementsCount = 0 }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col transition-colors duration-200 z-50">
      {/* Logo */}
